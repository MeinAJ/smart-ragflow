...
class ParserSettings(BaseSettings):
    ...
    EMBEDDING_TIMEOUT: float = Field(default=120.0, validation_alias="EMBEDDING_TIMEOUT")  # 增加默认超时到 120 秒
    ...
    EMBEDDING_CACHE_TTL: int = Field(default=864000, validation_alias="EMBEDDING_CACHE_TTL")  # 10天 = 864000秒
